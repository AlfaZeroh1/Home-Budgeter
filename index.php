...
<body>
    ...
    <iframe id="phasesIframe" src="php/phases_iframe.php?from=<?php echo isset($obj->from_phase)?$obj->from_phase:0; ?>&to=<?php echo isset($obj->to_phase)?$obj->to_phase:0; ?>" width="100%" height="700"></iframe>
